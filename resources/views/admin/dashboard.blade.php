...
@section('content')
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm p-5">
            ...
            @else
                <!-- Mengubah layout grid menjadi 4 kolom pada layar besar (lg:grid-cols-4) -->
        ...
        <div class="bg-white rounded-2xl shadow-sm overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
                ...
                <a href="{{ route('admin.tamu.index') }}" class="text-xs font-semibold text-[#173860] hover:underline">Lihat
                    Semua</a>
            </div>
