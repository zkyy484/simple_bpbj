        ...
        <nav class="px-3 py-4 space-y-6 text-sm font-medium">
            ...
            <div class="space-y-1">
               ...
               <a href="{{ route('index.sub') }}"
                ...
                <a href="#"
                   class="group flex items-center gap-3 px-3 py-2.5 rounded-lg transition {{ $navClass('tamu.*') }}">
                    <svg class="w-5 h-5 {{ $iconClass('tamu.*') }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="space-y-1">
                ...
                <div x-data="{ open: {{ request()->routeIs('survei.*') ? 'true' : 'false' }} }">
                    ...
                    <div x-show="open" x-collapse class="mt-1 pl-11 space-y-0.5">
                        <a href="#" class="block px-2 py-1.5 text-xs rounded-md {{ $navClass('survei.pertanyaan.*') }}">Pertanyaan</a>
