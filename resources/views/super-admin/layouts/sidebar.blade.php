        ...
        <nav class="px-3 py-4 space-y-6 text-sm font-medium">
            ...
            <div class="space-y-1">
                ...
                <a href="{{ route('index.sub') }}"
                    class="group flex items-center gap-3 px-3 py-2.5 rounded-lg transition {{ $navClass('index.sub*') }}">
                    <svg class="w-5 h-5 {{ $iconClass('index.sub*') }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2M5 21H3m4-14h.01M11 7h.01M15 7h.01M7 11h.01M15 11h.01M7 15h.01M11 15h.01M15 15h.01" />
                    </svg>
                    Sub Bagian
                </a>
                ...
                <a href="{{ route('tujuan.index') }}"
                    class="group flex items-center gap-3 px-3 py-2.5 rounded-lg transition {{ $navClass('tujuan.index*') }}">
                    <svg class="w-5 h-5 {{ $iconClass('tujuan.index*') }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 21v-4m0 0V5a2 2 0 012-2h6l2 2h6a2 2 0 012 2v8a2 2 0 01-2 2H9l-2-2H3z" />
                    </svg>
                    Tujuan
                </a>

                <a href="{{ route('jadwal_dinas.index') }}"
                    class="group flex items-center gap-3 px-3 py-2.5 rounded-lg transition {{ $navClass('jadwal_dinas.index*') }}">
                    <svg class="w-5 h-5 {{ $iconClass('jadwal_dinas.index*') }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 21v-4m0 0V5a2 2 0 012-2h6l2 2h6a2 2 0 012 2v8a2 2 0 01-2 2H9l-2-2H3z" />
                    </svg>
                    Jadwal Dinas
                </a>
                ...
                <a href="{{ route('log-aktivitas.index') }}"
                    ...
                    <svg class="w-5 h-5 {{ $iconClass('log-aktivitas.*') }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="space-y-1">
                ...
                {{-- Dropdown Survei --}}
                <div x-data="{ open: {{ request()->routeIs('super.index.*') || request()->routeIs('super.index.*') ? 'true' : 'false' }} }">
                    <button @click="open = !open"
                        class="w-full group flex items-center justify-between px-3 py-2.5 rounded-lg transition {{ $navClass('super.index.*') }}">
                        <span class="flex items-center gap-3">
                            <svg class="w-5 h-5 {{ $iconClass('super.index.*') }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div x-show="open" x-collapse class="mt-1 pl-11 space-y-0.5">
                        <a href="{{ route('super.index.pertanyaan') }}" class="block px-2 py-1.5 text-xs rounded-md {{ $navClass('super.index.pertanyaan') }}">Pertanyaan</a>
                        <a href="{{ route('super.index.survei') }}" class="block px-2 py-1.5 text-xs rounded-md {{ $navClass('super.index.survei') }}">Survei Tamu</a>
                    </div>
                </div>
                ...
                <div x-data="{ open: {{ request()->routeIs('laporan.*') ? 'true' : 'false' }} }">
                    <button @click="open = !open"
                        ...
                        <span class="flex items-center gap-3">
                            <svg class="w-5 h-5 {{ $iconClass('laporan.*') }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm6 0V9a2 2 0 00-2-2h-2a2 2 0 00-2 2v10a2 2 0 002 2h2a2 2 0 002-2zm6 0v-3a2 2 0 00-2-2h-2a2 2 0 00-2 2v3a2 2 0 002 2h2a2 2 0 002-2z" />
                            </svg>
                            Laporan
                        </span>
                        <svg class="w-4 h-4 transition-transform shrink-0" :class="open ? 'rotate-180' : ''"
