    ...
    <div class="flex-1 overflow-y-auto">
        ...
        <nav class="px-3 py-4 space-y-6 text-sm font-medium">
            ...
            <div class="space-y-1">
                ...
                <a href="{{ route('index.survei') }}"
                    class="group flex items-center gap-3 px-3 py-2.5 rounded-lg transition {{ $navClass('index.survei') }}">
                    <svg class="w-5 h-5 {{ $iconClass('index.survei') }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="space-y-1">
                ...
                <div x-data="{ open: {{ request()->routeIs('index.akun') || request()->routeIs('index.sub*') || request()->routeIs('tujuan.index*') || request()->routeIs('index.pertanyaan') ? 'true' : 'false' }} }">
                    <button @click="open = !open"
                        ...
                        <span class="flex items-center gap-3">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 7v10c0 1.1 3.6 2 8 2s8-.9 8-2V7M4 7c0 1.1 3.6 2 8 2s8-.9 8-2M4 7c0-1.1 3.6-2 8-2s8 .9 8 2m0 5c0 1.1-3.6 2-8 2s-8-.9-8-2" />
                            </svg>
                            Masterdata
                        </span>
                    ...
                    <div x-show="open" x-collapse class="mt-1 pl-11 space-y-0.5">
                        <a href="{{ route('index.sub') }}" class="block px-2 py-1.5 text-xs rounded-md {{ $navClass('index.sub*') }}">Sub Bagian</a>
                        <a href="{{ route('tujuan.index') }}" class="block px-2 py-1.5 text-xs rounded-md {{ $navClass('tujuan.index*') }}">Tujuan</a>
                        <a href="{{ route('index.akun') }}" class="block px-2 py-1.5 text-xs rounded-md {{ $navClass('index.akun') }}">Akun</a>
