    ...
    <div class="flex-1 overflow-y-auto">
        ...
        <nav class="px-3 py-4 space-y-6 text-sm font-medium">
            ...
            <div class="space-y-1">
                ...
                <a href="{{ route('super.pengaturan.index') }}"
                    class="group flex items-center gap-3 px-3 py-2.5 rounded-lg transition {{ $navClass('super.pengaturan.*') }}">
                    <svg class="w-5 h-5 {{ $iconClass('super.pengaturan.*') }}" fill="none"
                        stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
