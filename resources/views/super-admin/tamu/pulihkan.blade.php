<!-- Modal Konfirmasi Pulihkan Data Tamu -->
<div x-show="openPulihkan" x-cloak class="fixed inset-0 z-[999] flex items-center justify-center p-4">

    <!-- Overlay / Backdrop -->
    <div x-show="openPulihkan" x-transition.opacity @click="openPulihkan = false"
        class="absolute inset-0 bg-black/50 backdrop-blur-sm">
    </div>

    <!-- Modal Card -->
    <div x-show="openPulihkan" x-transition:enter="transition ease-out duration-300"
        x-transition:enter-start="opacity-0 scale-90" x-transition:enter-end="opacity-100 scale-100"
        x-transition:leave="transition ease-in duration-200" x-transition:leave-start="opacity-100 scale-100"
        x-transition:leave-end="opacity-0 scale-90" @click.outside="openPulihkan = false"
        ...
        <div class="bg-white px-6 py-5 flex items-center justify-between border-b border-gray-100">
            ...
            <!-- Tombol Close Merah -->
            <button type="button" @click="openPulihkan = false" aria-label="Tutup modal"
        ...
        <div class="p-6 text-center space-y-3">
            <p class="text-gray-600 text-sm">
                Apakah Anda yakin ingin memulihkan data tamu ini?
            </p>
        ...
        <form :action="pulihkanUrl" method="POST">
            ...
            <div class="bg-gray-50 border-t border-gray-200 px-6 py-4 flex justify-end gap-3">
                ...
                <button type="submit"
                    class="px-6 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-semibold transition flex items-center gap-2 text-sm shadow-sm">
