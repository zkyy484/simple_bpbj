    ...
    <div x-show="openDelete" 
        ...
        <div class="bg-white px-6 py-5 flex items-center justify-between border-b border-gray-100">
            <div class="flex items-center gap-3">
                ...
                <h2 class="text-lg font-bold text-gray-900 leading-tight">Hapus Data Tamu</h2>
            </div>
        ...
        <div class="p-6 text-center space-y-3">
            <p class="text-gray-600 text-sm">Apakah Anda yakin ingin menghapus data tamu ini?</p>
        ...
        <form :action="deleteUrl" method="POST">
            ...
            <div class="bg-gray-50 border-t border-gray-200 px-6 py-4 flex justify-end gap-3">
                ...
                <button type="submit"
                    class="px-6 py-2.5 rounded-xl bg-red-600 hover:bg-red-700 text-white font-semibold transition flex items-center gap-2 text-sm shadow-sm">
