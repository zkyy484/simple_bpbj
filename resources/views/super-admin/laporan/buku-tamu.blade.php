...
@section('content')
    <div class="space-y-6">
        ...
        <div id="tabel-laporan-wrapper">
            <div class="bg-white rounded-2xl shadow-sm overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
                    <h3 class="text-base font-bold text-gray-900">Daftar Laporan Buku Tamu</h3>
    ...
    (function () {
        ...
        function refreshTable() {
            ...
            fetch(buildRefreshUrl(), {
                ...
                .then((res) => {
                    if (!res.ok) throw new Error('Gagal memuat data laporan buku tamu.');
                    return res.text();
                })
                .then((html) => {
                    const parser = new DOMParser();
                    const doc = parser.parseFromString(html, 'text/html');
                    const newWrapper = doc.getElementById('tabel-laporan-wrapper');
