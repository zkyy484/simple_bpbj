    ...
    <div x-data="{
        ...
        <div class="space-y-6 transition-all duration-300"
            ...
            <div class="text-sm text-gray-500">
                ...
                <a href="{{ route('super.jenis.index') }}" class="hover:text-gray-700">Jenis Permohonan</a>
                <span class="mx-1">/</span>
            ...
            <div class="bg-white rounded-2xl shadow-sm p-6 flex flex-col lg:flex-row justify-between items-center gap-4">
                <form action="{{ route('super.jenis.arsip') }}" method="GET" class="flex-1 w-full max-w-md">
