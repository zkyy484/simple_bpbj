{{-- super-admin/jenis_permohonan/delete.blade.php --}}
    ...
    <div x-show="openDelete" x-transition:enter="transition ease-out duration-300"
        ...
        <div class="p-6 text-center space-y-3">
            <p class="text-gray-600 text-sm">
                Apakah Anda yakin ingin menghapus (mengarsipkan) jenis permohonan ini?
            </p>
        ...
        <!-- Footer Form -->
        <form action="{{ route('super.jenis.delete') }}" method="POST">
            @csrf
            @method('DELETE')

            <!-- Input Hidden menggunakan binding :value agar id terkirim secara reaktif -->
            <input type="hidden" name="id_jenis_permohonan" :value="selectedJenis.id">
