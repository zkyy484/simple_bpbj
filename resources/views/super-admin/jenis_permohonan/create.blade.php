<div x-show="openCreate" x-cloak class="fixed inset-0 z-[999] flex items-center justify-center p-4">
    ...
    <div x-show="openCreate" x-transition:enter="transition ease-out duration-300"
        ...
        <!-- Body -->
        <form action="{{ route('super.jenis.store') }}" method="POST">
            @csrf
            <div class="p-6 space-y-6">
                <div>
                    ...
                    <input type="text" name="nama_jenis_permohonan" value="{{ old('nama_jenis_permohonan') }}"
                        ...
                        class="w-full rounded-xl border px-4 py-3 outline-none transition focus:ring-2 focus:ring-[#173860] focus:border-[#173860] @error('nama_jenis_permohonan') border-red-500 @enderror">
