...
@section('title', 'Arsip Akun - Buku Tamu Digital')
...
@section('content')
    <div x-data="{
        ...
        setRestoreData(account) {
            this.selectedAccount = {
                id: account.id_user || account.id,
                nama: account.nama_lengkap || account.nama
            };
        ...
        <div class="space-y-6 transition-all duration-300"
            ...
            <h1 class="text-3xl font-bold text-gray-900">Arsip Data Akun</h1>
            ...
            <div class="bg-white rounded-2xl shadow-sm overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
                    <h3 class="text-base font-bold text-gray-900">Daftar Akun Terarsip</h3>
                            ...
                            @forelse($accounts as $index => $account)
                                <tr class="hover:bg-gray-50/50 transition align-top">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <span class="px-3 py-1 bg-gray-400 text-white rounded-full text-[11px] font-bold whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex justify-center items-center">
                                            <!-- Tombol Pulihkan Memanggil Function AlpineJS -->
                                            <button type="button"
        ...
        {{-- INCLUDE MODAL PULIHKAN AKUN --}}
        @include('super-admin.akun.pulihkan')
